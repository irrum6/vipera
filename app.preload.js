...
customElements.define('pop-x', PopX);class FramelessPop extends GWindow {
    #initialWidth;
    #initialHeight;
    constructor() {
        super();
...
customElements.define('frameless-pop', FramelessPop);class NewGameDialog extends HTMLElement {
    constructor() {
        super();
